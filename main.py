...
║          Language: Python | AI: Gemini | Deploy: Render/Railway ║
╚══════════════════════════════════════════════════════════════════╝
"""
...
async def help_command(interaction: discord.Interaction):
    embed = discord.Embed(
        ...
        description='Your intelligent Discord server management assistant, powered by Google Gemini AI.',
    ...
    embed.add_field(
        ...
        value='`/ask` `/toxcheck` `/summarize` `/moderate` `/clearcontext`\n@mention me to chat!',
        inline=False
    )
    embed.add_field(
        name='🔧 Auto-Mod',
    ...
    embed.set_footer(text='AI Co-Admin Bot • Powered by Google Gemini | @mention me to chat!')
